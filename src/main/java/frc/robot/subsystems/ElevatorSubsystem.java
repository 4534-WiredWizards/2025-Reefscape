...
//             C_Elevator.kS, C_Elevator.kG, C_Elevator.kV, C_Elevator.kA);
...
//         elevatorMotor = new SparkFlex(C_Elevator.leftMotorID, MotorType.kBrushless); // Replace
// with the correct CAN ID
...
//         // TODO: Position Conversion Factor: Setting it to 1.0 leaves encoder units as motor
// rotations. Convert to real-world units (e.g., meters) using gear ratios or pulley dimensions
//         motorConfig.encoder.positionConversionFactor(1.0);

//         elevatorMotor.configure(motorConfig, ResetMode.kResetSafeParameters,
// PersistMode.kPersistParameters);

//         // Initialize PID controller
//         pidController = new PIDController(C_Elevator.kP, C_Elevator.kI, C_Elevator.kD);
//         pidController.setTolerance(C_Elevator.PIDPositionTolerance,
// C_Elevator.PIDVelocityTolerance); // Set the
//
//     // tolerance to
//
//     // 0.1 units
