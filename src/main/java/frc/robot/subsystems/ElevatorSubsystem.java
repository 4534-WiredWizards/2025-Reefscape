...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    public ElevatorSubsystem() {
        ...
        elevatorMotor = new SparkFlex(C_Elevator.leftMotorID, MotorType.kBrushless); // Replace with the correct CAN ID
        ...
        pidController.setTolerance(C_Elevator.PIDPositionTolerance, C_Elevator.PIDVelocityTolerance); // Set the
                                                                                                      // tolerance to
                                                                                                      // 0.1 units
                                                                                                      // (e.g., inches)
