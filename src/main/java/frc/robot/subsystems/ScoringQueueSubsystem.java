...
public class ScoringQueueSubsystem extends SubsystemBase {
  ...
  public ScoringQueueSubsystem(Drive drive, ElevatorSubsystem elevator, WristSubsystem wrist) {
    this.drive = drive;
  ...
  public void addScoringCommand(ScoringSide side, ScoringHeight height) {
    ...
    commandQueue.add(new CoralScoringCommand(drive, elevator, wrist, side, height));
  }
