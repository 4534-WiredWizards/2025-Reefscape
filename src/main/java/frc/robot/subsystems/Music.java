...
private final TalonFX BackRightTurn = new TalonFX(45);
  ...
  public Music() {
    ...
    m_orchestra.addInstrument(BackLeftDrive, 1);
    m_orchestra.addInstrument(BackLeftTurn, 1);
    m_orchestra.addInstrument(BackRightDrive, 1);
    m_orchestra.addInstrument(BackRightTurn, 1);
  }
