...
//     absEncoder = new
// DutyCycleEncoder(C_Wrist.Encoder.port,C_Wrist.Encoder.fullRange,C_Wrist.Encoder.expectedZero);
...
//     wristMotor.configure(brakeConfig, ResetMode.kResetSafeParameters,
// PersistMode.kPersistParameters);
//     rollerMotor.configure(IdleConfig, ResetMode.kResetSafeParameters,
// PersistMode.kPersistParameters);
...
// m_WristFeedforward.calculate(Units.degreesToRadians(getAngle()),pidoutput));
//     double feedforward =
