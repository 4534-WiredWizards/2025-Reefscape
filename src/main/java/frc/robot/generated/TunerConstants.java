...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGains =
      new Slot0Configs()
          .withKP(Swerve.Steer.PID.KP)
          .withKI(Swerve.Steer.PID.KI)
          .withKD(Swerve.Steer.PID.KD)
          .withKS(Swerve.Steer.PID.KS)
          .withKV(Swerve.Steer.PID.KV)
          .withKA(Swerve.Steer.PID.KA)
  ...
  private static final Slot0Configs driveGains =
      ...
      // new
      // Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.19335).withKV(0.88251);
      // Tuning after SysId
      // new
      // Slot0Configs().withKP(0.06134).withKI(0).withKD(0).withKA(0.01698).withKS(0.19258).withKV(0.50239);
      ...
      new Slot0Configs()
          .withKP(Swerve.Drive.PID.KP)
          .withKI(Swerve.Drive.PID.KI)
          .withKD(Swerve.Drive.PID.KD)
          .withKS(Swerve.Drive.PID.KS)
          .withKV(Swerve.Drive.PID.KV)
          .withKA(Swerve.Drive.PID.KA);
